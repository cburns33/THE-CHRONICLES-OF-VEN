...
You only do this once. After that, just open ChatGPT and use it anytime.
...
4. Paste this URL exactly as written:
   ```
   https://novel.talos-advisory.com/api/openapi.json
   ```
5. Click **Import**
...
Just open ChatGPT → My GPTs → Chronicles of Ven. It's available anytime,
no coordination needed.

The manuscript syncs automatically every night, so new chapters you write
